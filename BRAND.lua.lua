...
if hash or SudoBot(msg) or DevBRANDW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local BRAND_Msg = ''  
if msgs < 100 then 
BRAND_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BRAND_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BRAND_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BRAND_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BRAND_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BRAND_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BRAND_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BRAND_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BRAND_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BRAND_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BRAND_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BRAND_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BRAND_Msg = 'رب التفاعل'  
end 
return BRAND_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBRAND(msg,data) -- بداية العمل
if msg then
...
SourceBRANDr = '✯∫اهلا عزيزي\n ✯∫انا بوت اسمي '..Namebot..'\n ✯∫اختصاصي حمايه الكروبات\n ✯∫من تكرار والسبام والتوجيه والخ…\n ✯∫لتفعيلي اتبع الاخطوات…↓\n ✯∫اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ✯∫[قناة سورس البوت](http://t.me/CXRCX)'
end 
send(msg.chat_id_, msg.id_, SourceBRANDr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevBRANDW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBRANDW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BRAND_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✯' and DevBRANDW(msg) then  
...
if text == 'تعطيل التواصل ✯' and DevBRANDW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✯' and DevBRANDW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✯' and DevBRANDW(msg) then  
...
if text == 'ضع كليشه ستارت ✯' and DevBRANDW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✯∫ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✯' and DevBRANDW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✯∫تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✯' and DevBRANDW(msg) then 
...
if text == 'المشتركين ✯' and DevBRANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✯∫المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✯' and DevBRANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✯∫الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✯") and DevBRANDW(msg) then
...
if text == ("قائمه العام ✯") and DevBRANDW(msg) then
...
if text == ("قائمه الكتم العام ✯") and DevBRANDW(msg) then
...
if text=="اذاعه خاص ✯" and msg.reply_to_message_id_ == 0 and DevBRANDW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯∫ارسل الان اذاعتك؟ \n ✯∫للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✯" and msg.reply_to_message_id_ == 0 and DevBRANDW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯∫ارسل الان اذاعتك؟ \n ✯∫للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✯" and msg.reply_to_message_id_ == 0 and DevBRANDW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯∫ارسل الان اذاعتك؟ \n ✯∫للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✯" and msg.reply_to_message_id_ == 0  and DevBRANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯∫ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✯" and msg.reply_to_message_id_ == 0  and DevBRANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯∫ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✯' and DevBRANDW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✯" and DevBRANDW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✯" and DevBRANDW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✯∫ عدد الكروبات الان » { '..#group..' }'..BRANDk..''..BRAND..'\n✯∫ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ✯∫العضو » ['..result.title_..'](t.me/'..(username or 'CXRCX')..')'
status  = '\n ✯∫تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevBRANDW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBRANDW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBRANDW(msg) then
...
local BRAND1_Msg = database:get(bot_id.."BRAND1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BRAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯∫العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CXRCX')..') \n ✯∫'..BRAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BRAND_Msg and not Special(msg) then  
local BRAND_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BRAND_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯∫العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯∫["..BRAND_Msg.."] \n")
else
send(msg.chat_id_,0," ✯∫العضو : {["..data.first_name_.."](T.ME/CXRCX)}\n ✯∫["..BRAND_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯∫عذرا » {["..data.first_name_.."](T.ME/CXRCX)}\n ✯∫عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBRANDW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBRANDW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBRANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯∫حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBRANDW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯∫حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✯" and DevBRANDW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✯∫تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯$") and DevBRANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯∫حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯" and DevBRANDW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✯" and DevBRANDW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✯∫تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✯" and DevBRANDW(msg) then  
...
database:sadd(bot_id.."BRAND:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BRAND:blocname"..msg.chat_id_)
...
if name_BRAND then 
names_BRAND = database:smembers(bot_id.."BRAND:blocname"..msg.chat_id_) or ""
if names_BRAND and names_BRAND[1] then 
for i=1,#names_BRAND do 
if name_BRAND:match("(.*)("..names_BRAND[i]..")(.*)") then 
...
database:set(bot_id.."BRAND:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BRAND:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BRAND:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BRAND:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BRAND:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BRANDa_new(BRAND1,BRAND2)
if BRAND2 and BRAND2.first_name_ then 
if BRAND2.first_name_:match("(.*)"..database:get(bot_id.."BRAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BRAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BRAND_nnn = database:get(bot_id.."BRAND:nump"..msg.chat_id_) or 5
local BRAND_nnn2 = database:get(bot_id.."BRAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BRAND_nnn2) == tonumber(BRAND_nnn) or tonumber(BRAND_nnn2) > tonumber(BRAND_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BRAND:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯∫عزيزي >>["..BRAND2.username_.."](https://t.me/"..(BRAND2.username_ or "CXRCX")..")\n✯∫عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BRAND:teh"..msg.chat_id_).."} بجانب اسمك\n✯∫عدد المحاولات المتبقيه {"..(tonumber(BRAND_nnn) - tonumber(BRAND_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BRANDa_new)
end
end
...
local BRANDChengName = database:get(bot_id.."BRAND:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BRANDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BRANDChengName..']')
database:del(bot_id.."BRAND:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BRANDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BRAND:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BRANDChengUserName = database:get(bot_id.."BRAND:Cheng:UserName"..data.id_)
if not data.username_ then 
if BRANDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BRANDChengUserName..']')
database:del(bot_id.."BRAND:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BRANDChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BRAND:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BRANDChengPhoto = database:get(bot_id.."BRAND:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BRANDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BRAND:Cheng:Photo"..data.id_) 
end
end
...
database:set(bot_id.."BRAND:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⍆══•═══𝘽𝙍══•═══⍅
 ✯∫↬𝘽𝙍𝘼𝙉𝘿 𝙏𝙀𝘼𝙈
⍆══•═══𝘽𝙍══•═══⍅
 ✯∫↬[Channel BRAND](t.me/CXRCX) 
⍆══•═══𝘽𝙍══•═══⍅
 ✯∫↬[Information](t.me/GXKXG)
⍆══•═══𝘽𝙍══•═══⍅
 ✯∫↬[DEVELOPER](t.me/S_X_X_G)
⍆══•═══𝘽𝙍══•═══⍅
 ✯∫↬[To talk to us](t.me/CXTCXBOT)
 ⍆══•═══𝘽𝙍══•═══⍅
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevBRANDW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✯∫بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CXRCX')..') \n ✯∫تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯∫بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CXRCX')..') \n ✯∫تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBRANDW(msg) then    
dofile('BRAND.lua')  
send(msg.chat_id_, msg.id_, ' ✯∫تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBRANDW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBRANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBRANDW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBRANDW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBRANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBRANDW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBRANDW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBRANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBRANDW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBRANDW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBRANDW(msg) then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBRANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "CXRCX")
...
function Function_BRAND(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRAND, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BRAND, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯∫لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
status  = '\n ✯∫تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯∫العضو » '..userid..''
...
database:set(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯∫ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BRAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BRAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯∫تم منع الكلمه مع التحذير")  
database:del(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BRAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BRAND1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BRAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯∫ارسل الكلمه الان")  
database:set(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BRAND1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BRAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BRAND1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BRAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BRAND1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BRAND1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✯∫قائمة المنع \n⍆══•═══𝘽𝙍══•═══⍅\n"
for k,v in pairs(list) do  
local BRAND_Msg = database:get(bot_id.."BRAND1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BRAND_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBRANDW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✯∫تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBRANDW(msg) then
...
if text == 'تفعيل الاذاعه' and DevBRANDW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBRANDW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..BRAND_Msg[math.random(#BRAND_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBRANDW(msg) then 
...
if text == ("ردود المطور") and DevBRANDW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✯∫قائمة ردود المطور \n⍆══•═══𝘽𝙍══•═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBRANDW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBRANDW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevBRANDW(msg) then   
...
if text == 'تعطيل المغادره' and DevBRANDW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯∫العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BRAND')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
local iduser = result.sender_user_id_
...
" ✯∫شلون عدي زواجل",
" ✯∫غالي وغالي ",
" ✯∫اركعك بكله اطشر وجهك ",
" ✯∫شبيك كالب خلقتك ",
" ✯∫ابن المطي ",
" ✯∫باع الحم موش بنيه ضيم ",
" ✯∫نروح خاص ",
}
...
-- vardump(data) 
BRANDdx(msg.chat_id_, msg.id_, ' ✯∫ايدي المجموعة » ( '..msg.chat_id_..' )\n ✯∫عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✯∫عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✯∫عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBRANDW(msg) then
...
Maany_Rand = {'قرد','دجاجه','بطريق','ضفدع','بومه','نحله','ديك','جمل','بقره','دولفين','تمساح','قرش','نمر','اخطبوط','سمكه','خفاش','اسد','فأر','ذئب','فراشه','عقرب','زرافه','قنفذ','تفاحه','باذنجان''نعامه','غزال','وحيدالقرن','فيل','غوريلا','تمساح','ديناصور','سرطان','روبيان','جراده','نمله','دعسوقه','لابتوب','ساعه','هاتف','راديو','دب','دوده','جاكوج','سبانه','دنبوس','ميزان','تابوت','صحن'}
...
name = string.gsub(name,'نعامه','🦚')
name = string.gsub(name,'غزال',🦌'')
name = string.gsub(name,'وحيد القرن','🦏')
name = string.gsub(name,'فيل','🐘')
name = string.gsub(name,'غوريلا','🦍')
name = string.gsub(name,'تمساح','🐊')
name = string.gsub(name,'ديناصور','🦖')
name = string.gsub(name,'سرطان','🦞')
name = string.gsub(name,'روبيان','🦐')
name = string.gsub(name,'جراده',🦗'')
name = string.gsub(name,'نمله','🐜')
name = string.gsub(name,'دعسوقه','🐞')
name = string.gsub(name,'لابتوب','💻')
name = string.gsub(name,'طابعه','🖨')
name = string.gsub(name,'ساعه','⌚️')
name = string.gsub(name,'هاتف','📱')
name = string.gsub(name,'ردايو','📻')
name = string.gsub(name,'دب','🐻')
name = string.gsub(name,'دوده','🐛')
name = string.gsub(name,'جاكوج','🔨')
name = string.gsub(name,'سبانه','🔧')
name = string.gsub(name,'دنبوس','🧷')
name = string.gsub(name,'ميزان','⚖️')
name = string.gsub(name,'تابوت','⚰️')
name = string.gsub(name,'صحن','📡')
...
BRAND = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BRAND)
...
------------------------------------------------------------------------
local BRANDAbot = database:get(bot_id.."BRAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if BRANDAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯∫العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯∫["..BRANDAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BRAND1_Msg = database:get(bot_id.."BRAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if BRAND1_Msg then    
send(msg.chat_id_, msg.id_," ✯∫"..BRAND1_Msg)
